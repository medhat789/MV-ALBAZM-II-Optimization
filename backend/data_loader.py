...
CE_DAILY_LOG_PATH = BASE_DIR / "CE_Daily_Log_2024_2025.csv"
ROB_PATH = BASE_DIR / "OfficialROB2024-NOV2025.csv"
ECDIS_PATH = BASE_DIR / "ecdis_weather_data.csv"
...
def _find_file(csv_path: Path, xlsx_path: Path) -> Optional[Path]:
    if csv_path.exists():
        return csv_path
    if xlsx_path.exists():
        return xlsx_path
